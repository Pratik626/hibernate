...
public class App {
    public static void main(String[] args) {
        ...
        Student stu = new Student(101, "Pratik");
        ...
        config.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/pratikdb?createDatabaseIfNotExist=true");
        config.setProperty("hibernate.connection.username", "root");
        config.setProperty("hibernate.connection.password", "Pratik@2002");
